                            <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                ...
                                <tr>
                                    ...
                                    <td class="center">@if($category->active ==1)
                                            <label class="btn btn-primary">Active</label>
                                                           @else
                                            <label class="btn btn-danger">Inactive</label> @endif
                                    </td>
                                    {!! Form::Close() !!}
                                    <td>
                                    ...
                                    <td>
                                        <button data-id="{{$category->id}}" onclick="deletefunction({{$category->id}},'{{url('/')}}')"> Delete </button>
                                    </td>
                                </tr>
                                    @endforeach
                                </tbody>
