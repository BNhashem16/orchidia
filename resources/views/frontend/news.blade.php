              ...
              <div class="col-md-10">
                <article class="post news_posts">
                  ...
                  <div style="color:black;" class="col-md-6 col-sm-6 col-xs-6">
                    <h2 style="font-weight: 900;font-size: 20px;font-family: 'Raleway', 'Helvetica Neue', Helvetica, Arial, sans-serif;" class="post_title post_title2"><a href="{{'News/'.$new->link}}">{{$new->title[$app->getLocale()]}}</a></h2>
